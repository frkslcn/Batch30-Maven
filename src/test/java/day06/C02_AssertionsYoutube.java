...
public class C02_AssertionsYoutube {
    ...
    public static void setup(){
        ...
        driver.findElement(By.xpath("//*[text()='I Agree']"));
       ...
       String actualTitle = driver.getTitle();
           Assert.assertEquals("Sayfa title i farkli",expectedTitle,actualTitle);
       ...
       public void aramaKutusuTesti(){
        ...
        Assert.assertTrue("AramaKutusuna ulasilamiyor",aramaKutusu.isEnabled());
